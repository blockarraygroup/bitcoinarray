...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitcoinArrayTestFramework
    pass

class ExampleTest(BitcoinArrayTestFramework):
    # Each functional test is a subclass of the BitcoinArrayTestFramework class.
    ...
    def custom_method(self):
        ...
        BitcoinArrayTestFramework class so other tests can use it."""
