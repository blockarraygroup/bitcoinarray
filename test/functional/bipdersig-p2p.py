...
class BIP66Test(BitcoinArrayTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # bitcoinarrayd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and bitcoinarrayd produces more specific reject
            # reasons.
