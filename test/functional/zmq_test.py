...
from test_framework.test_framework import BitcoinArrayTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (BitcoinArrayTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that bitcoinarray has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("bitcoinarrayd has not been built with zmq enabled.")
