BitcoinArray Core version 0.14.2 is now available from:

  <https://bitcoinarray.org/bin/bitcoinarray-core-0.14.2/>
...
(in BitcoinArray Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in BitcoinArray-Qt when using coin
...
- #10228 `ae479bc` Regenerate bitcoinarray-config.h as necessary (theuni)
