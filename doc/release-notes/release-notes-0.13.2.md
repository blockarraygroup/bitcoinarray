BitcoinArray Core version 0.13.2 is now available from:

  <https://bitcoinarray.org/bin/bitcoinarray-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoinarray-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoinarray-tx to create v2 transactions (btcdrak)
