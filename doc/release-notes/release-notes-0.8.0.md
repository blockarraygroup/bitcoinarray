BitcoinArray-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoinarray/files/BitcoinArray/bitcoinarray-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitcoinArray
...
New/changed settings (command-line or bitcoinarray.conf file)
--------------------------------------------------------
