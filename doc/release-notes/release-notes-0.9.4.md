BitcoinArray Core version 0.9.4 is now available from:

  https://bitcoinarray.org/bin/0.9.4/
...
this update is incompatible with the BitcoinArray system and could lead to consensus
forks.

BitcoinArray Core released binaries from https://bitcoinarray.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoinarray/+archive/ubuntu/bitcoinarray
- A third-party or self-compiled BitcoinArray Core

upgrade to BitcoinArray Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
