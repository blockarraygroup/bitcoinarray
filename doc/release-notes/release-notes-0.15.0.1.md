BitcoinArray Core version *0.15.0.1* is now available from:

  <https://bitcoinarray.org/bin/bitcoinarray-core-0.15.0.1/>

and

  <https://bitcoinarraycore.org/bin/bitcoinarray-core-0.15.0.1/>
