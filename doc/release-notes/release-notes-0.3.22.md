Download URL: https://sourceforge.net/projects/bitcoinarray/files/BitcoinArray/bitcoinarray-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BRY fee schedule (users still pay 0.01 BRY per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoinarray00 - #bitcoinarray99
