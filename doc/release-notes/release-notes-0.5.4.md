BitcoinArray version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoinarray/files/BitcoinArray/bitcoinarray-0.5.4/
...
http://gitorious.org/bitcoinarray/bitcoinarrayd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BitcoinArray-Qt notifications under Growl 1.3.
Increase required age of BitcoinArray-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoinArray properly when installing BitcoinArray-Qt over it. (Windows)
