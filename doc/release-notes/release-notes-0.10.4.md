BitcoinArray Core version 0.10.4 is now available from:

  <https://bitcoinarray.org/bin/bitcoinarray-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoinarray-tx into its own package
- #6953 `dfe0d4d` Include bitcoinarray-tx binary on Debian/Ubuntu
