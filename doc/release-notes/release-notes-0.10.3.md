BitcoinArray Core version 0.10.3 is now available from:

  <https://bitcoinarray.org/bin/bitcoinarray-core-0.10.3/>
...
(see https://github.com/bitcoinarray/bitcoinarray/pull/6793, as well as the 0.11.0
