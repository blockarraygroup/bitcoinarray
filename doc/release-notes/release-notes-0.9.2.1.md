BitcoinArray Core version 0.9.2.1 is now available from:

  https://bitcoinarray.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BRY to 0.01 BRY
...
- Fix "Start bitcoinarray on system login"
