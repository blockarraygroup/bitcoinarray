...
This document provides guidelines for internationalization of the BitcoinArray Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinarray_en.ts` remains unchanged.
