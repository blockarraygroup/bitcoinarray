...
unlocked to sign the BitcoinArray-Qt.app bundle.
...
allowing somebody to distribute a BitcoinArray-Qt.app or bitcoinarray-qt-setup.exe with a valid
...
that the bitcoinarray-qt.exe file inside the installer had not been tampered with.
