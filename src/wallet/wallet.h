...
#ifndef BITCOINARRAY_WALLET_WALLET_H
#define BITCOINARRAY_WALLET_WALLET_H
...
public:
     ...
     * on this bitcoinarray node, and set to 0 for transactions that were created
...
#endif // BITCOINARRAY_WALLET_WALLET_H
