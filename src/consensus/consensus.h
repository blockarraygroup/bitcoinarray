...
#ifndef BITCOINARRAY_CONSENSUS_CONSENSUS_H
#define BITCOINARRAY_CONSENSUS_CONSENSUS_H
...
// version. The former uses BitcoinArray parameters, but if this fork is a fork
...
#endif // BITCOINARRAY_CONSENSUS_CONSENSUS_H
