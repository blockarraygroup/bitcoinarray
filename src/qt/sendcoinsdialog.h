...
#ifndef BITCOINARRAY_QT_SENDCOINSDIALOG_H
#define BITCOINARRAY_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending bitcoinarrays */
...
#endif // BITCOINARRAY_QT_SENDCOINSDIALOG_H
