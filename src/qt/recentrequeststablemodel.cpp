    ...
    if (role == Qt::DisplayRole || role == Qt::EditRole) {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return BitcoinArrayUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, BitcoinArrayUnits::separatorNever);
            else
                return BitcoinArrayUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
...
{
    return (this->walletModel->getOptionsModel() != nullptr) ? tr("Requested") + " (" + BitcoinArrayUnits::name(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
