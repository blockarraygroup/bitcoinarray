...
#ifndef BITCOINARRAY_TEST_SCRIPTNUM10_H
#define BITCOINARRAY_TEST_SCRIPTNUM10_H
...
{
    /**
 * The ScriptNum implementation from BitcoinArray Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINARRAY_TEST_BIGNUM_H
