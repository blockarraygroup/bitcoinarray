 ...
 * between bitcoinarrayd, and bitcoinarray-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("bitcoinarray-shutoff");
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), BITCOINARRAY_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitcoinarray/bitcoinarray>";
    const std::string URL_WEBSITE = "<https://bitcoinarraycore.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("bitcoinarray-loadblk");
...
/** Sanity checks
 *  Ensure that BitcoinArray is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("BitcoinArray version %s\n", FormatFullVersion());
}
...
bool AppInitParameterInteraction()
{
    ...
    if (gArgs.GetBoolArg("-disablefork", false)) {
        printf("NOTE: disabling fork; this node will run on the bitcoinarray network\n");
        FORK_ALLOWED = false;
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single BitcoinArray process is using the data directory.
...
// ********************************************************* Step 4a: application initialization
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", BITCOINARRAY_CONF_FILENAME)).string());
